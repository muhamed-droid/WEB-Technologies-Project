export let TabelaPrisustvo = function (divRef, podaci) {
            ...
            if(spajaj==false){
                ...
                if(j>=2 && j==trenutna+1){
                    ...
                    for(let k = 0; k <podaci.prisustva.length; k++){
                        if(podaci.prisustva[k].sedmica==j-1 && podaci.studenti[i].index==podaci.prisustva[k].index){
    ...
    let sljedecaSedmica = function () {
        if(trenutna<14) 
        trenutna++;
        //icrtavati sa trenutnim koji je manji za jedan
        divRef.innerHTML = "";
    ...
    let prethodnaSedmica = function () {
        if(trenutna>1)
        trenutna--;
        //stavit ću iscrtavanje sa trenutnim koje je veće
